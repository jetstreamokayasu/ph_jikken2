<<<<<<< HEAD
noize.torus<- matrix(decay*rnorm(point*3), point)
torus.500.10 <- lapply(1:10,function(i){noize.torus<- matrix(0.3*rnorm(500*3), 500)
  return(torusUnif(500,1,2.5) + noize.torus)
=======
require(TDA)

#noize.torus<- matrix(decay*rnorm(point*3), point)
torus.500.10 <- lapply(1:10,function(i){noize.torus<- matrix(0.3*rnorm(500*3, 0, runif(1, 0,2)), 500)
  return(torusUnif(round(runif(1, 200, 600)),1,2.5) + noize.torus)
>>>>>>> e9df030ecf1127b1b9852b68199680ce87246806
  })
set.seed(1908)
